...
class TestTimesTen(unittest.TestCase):
    ...
    def test_multiply_ten_by_one_million(self):
        self.assertEqual(times_ten(1000000), 100000000, 'Expected times_ten(1000000) to return 10000000')

    def test_multiply_ten_by_negative_number(self):
        self.assertEqual(times_ten(-10), -1000, 'Expected add_times_ten(-10) to return -100')
